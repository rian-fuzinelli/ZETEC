    ...
    <section id="hero" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 mt-16 pt-16 pb-36 border-t border-primary-foreground/30 relative z-20">
            <div className="text-center group">
              <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-3 drop-shadow-[0_4px_12px_rgba(255,255,255,0.5)] group-hover:scale-110 transition-transform">10+</div>
              <div className="text-primary-foreground text-sm md:text-base font-medium">Anos de experiência</div>
            </div>
            <div className="text-center group">
              <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-3 drop-shadow-[0_4px_12px_rgba(255,255,255,0.5)] group-hover:scale-110 transition-transform">500+</div>
              <div className="text-primary-foreground text-sm md:text-base font-medium">Clientes atendidos</div>
            </div>
            <div className="text-center group">
              <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-3 drop-shadow-[0_4px_12px_rgba(255,255,255,0.5)] group-hover:scale-110 transition-transform">100%</div>
